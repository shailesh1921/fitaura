              ...
              {message.role === 'assistant' ? (
                <div className="flex items-end gap-2 max-w-[85%]">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-3.5 rounded-2xl rounded-bl-sm text-sm text-white/90 shadow-[0_0_15px_rgba(112,0,255,0.1)] leading-relaxed">
                      {message.content}
                    </div>
